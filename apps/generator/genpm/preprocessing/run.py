...
def run_preprocessing(sdm: SparkDataManager, preprocessing_cfg: PreprocessingConfig) -> None:
    ...
    pm_training_windows_density = kpi_coverage.compute_window_density_sparse(
        ...
        density_threshold=preprocessing_cfg.kpi_window_coverage_frac,
    )
    ...
    # TODO: The below filter doesnt make sense and IS JUST WRONG
    # IT DOESNT COMPUTE THE REAL NUMBER OF WINDOWS
    # AND THEN THE THEORETICAL_MAX SH*TS UP THE LATER WINDOW COVERAGE
