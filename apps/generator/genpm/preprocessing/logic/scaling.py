    ...
    def _stats_df(self, df: DataFrame) -> DataFrame:
        ...
        return (
            ...
            .agg(
                ...
                f.when(f.min(v) == f.max(v), f.lit(1)).otherwise(f.lit(0)).alias("constant_raw"),
                f.first_value("kpi_value").alias("first_value_kpi_value"),
            )
            .select(
                *self.group_cols,
                "n_valid",
            ...
            .withColumns(
                {
                    ...
                    "param_a": (
                        ...
                        .when(f.col("scaler") == "const_val", f.col("first_value_kpi_value"))
