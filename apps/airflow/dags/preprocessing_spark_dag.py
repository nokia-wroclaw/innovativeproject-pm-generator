...
_SPARK_DRIVER_MEMORY = os.environ.get("SPARK_DRIVER_MEMORY", "24g")
_SPARK_EXECUTOR_MEMORY = os.environ.get("SPARK_EXECUTOR_MEMORY", "24g")
_SPARK_CORE_NUMBER = os.environ.get("SPARK_CORE_NUMBER", "8")
...
with DAG(
    ...
    SparkSubmitOperator(
        ...
        deploy_mode="cluster",
        application="/opt/airflow/spark-apps/preprocessing_spark_job.py",
        name="PreprocessingSparkApp",
        verbose=True,
        execution_timeout=timedelta(hours=3),
        conf={
            "spark.pyspark.driver.python": _SPARK_EXECUTOR_PYTHON,
            "spark.pyspark.python": _SPARK_EXECUTOR_PYTHON,
            "spark.driver.memory": _SPARK_DRIVER_MEMORY,
            "spark.executor.memory": _SPARK_EXECUTOR_MEMORY,
            "spark.executor.cores": _SPARK_CORE_NUMBER,
            "spark.cores.max": _SPARK_CORE_NUMBER,
        },
        env_vars={
            "GENPM_PYSPARK_PYTHON": _SPARK_EXECUTOR_PYTHON,
            "GENPM_SPARK_EXECUTOR_PYTHON": _SPARK_EXECUTOR_PYTHON,
            "GENPM_SPARK_CONFIG": os.environ.get("GENPM_SPARK_CONFIG", "AGG_HEAVY"),
            "SPARK_CORE_NUMBER": _SPARK_CORE_NUMBER,
            "SPARK_EXECUTOR_MEMORY": _SPARK_EXECUTOR_MEMORY,
            "SPARK_DRIVER_MEMORY": _SPARK_DRIVER_MEMORY,
            ...
            "PYSPARK_DRIVER_PYTHON": _SPARK_EXECUTOR_PYTHON,
